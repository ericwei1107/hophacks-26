...
export const missionVideos: MissionVideo[] = [
  ...
  { id: "success-lunar-arrival", role: "success", filename: "success-lunar-arrival.mp4", duration: 6, resolution: "720p", prompt: "Cinematic orbital view, a compact fictional spacecraft coasts into lunar orbit while Earth rises beyond the Moon's cratered horizon, precise restrained motion, physically plausible sunlight, no logos, no text, silent." },
  ...
  { id: "failure-guidance", role: "failure", filename: "failure-guidance.mp4", duration: 6, resolution: "720p", prompt: "Cinematic mission simulation visualization: a fictional research rocket experiences guidance loss during ascent, slowly tumbles away from its intended trajectory into high clouds, no impact, no explosion, no people, no logos, no text, silent." },
