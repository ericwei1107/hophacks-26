...
from regulations import format_for_grok
...
6) Mention the regulatory result if it is not compliant.
...
Collision-avoidance Δv uses the mission cam_scale, not a 750 km Gaussian and not operational Pc.
